...
The control hub daughterboard contains a RK3328 Quad-core ARM Cortex-A53 running a custom version of Android/Linux. This software is open source, but has nothing notible except for some software that manages the Wi-Fi access point. It has no thermal spreading, such as heat sinks, on the chip, which can cause thermal throttling when heavy processes such as vision pipelines are used.
